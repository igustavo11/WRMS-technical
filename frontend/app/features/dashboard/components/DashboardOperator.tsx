		...
		<div className="p-4 md:p-8 flex flex-col gap-6 md:gap-8 max-w-[1200px]">
			...
			<div className="hidden md:block">
				...
				<p className="text-[#a0a0a0] text-[14px] mt-1">
					Bem-vindo de volta, {firstName}. Aqui está o seu resumo de hoje.
				</p>
			</div>

			{/* Mobile CTA Card (Figma 1-2436) — hidden on desktop */}
				...
				<div className="flex flex-col gap-4">
					<div className="flex flex-col gap-1">
						...
						<p className="text-[#a0a0a0] text-[14px] leading-[21px]">
							Inicie um novo processo de alocação de inventário.
						</p>
					</div>
					<Button
			...
			{/* Metrics — 2 col on mobile, 3 col on desktop */}
			<div className="grid grid-cols-2 md:grid-cols-3 gap-4">
				{/* Estoque */}
				<div className="bg-[#161616] md:bg-[#1e1e1e] border border-[#2a2a2a] rounded-[8px] md:rounded-[8px] p-[17px] md:p-[21px] flex flex-col gap-[8px] md:justify-between md:min-h-[164px]">
					...
					<div>
						<p className="text-[#f0f0f0] text-[36px] font-bold tracking-[-0.72px] leading-[1.2]">
							{metrics.totalInventory.toLocaleString('pt-BR')}
						</p>
						<p className="text-[#a0a0a0] text-xs mt-1 hidden md:block">
							Unidades em toda a rede
						</p>
				...
				{/* Criadas Hoje — full width on mobile */}
			...
			{/* Desktop CTA banner — hidden on mobile */}
			<div className="hidden md:flex bg-[#1e1e1e] border border-[#2a2a2a] rounded-[8px] p-[21px] items-center justify-between relative overflow-hidden">
				...
				<div className="flex flex-col gap-2">
					...
					<p className="text-[#a0a0a0] text-[14px] max-w-[448px]">
						Inicie uma nova solicitação de materiais para projetos aprovados
						diretamente do inventário disponível.
					</p>
				</div>
				<Button
					onClick={() => navigate('/reservations')}
